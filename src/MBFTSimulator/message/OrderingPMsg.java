...
/**
 * @ClassName: OrderingPMsg
 * @Description:
 * @Author: Dongxu Zhu
 **/
public class OrderingPMsg extends Message{
    ...
    public OrderingPMsg(int v, int n, Message m, int i, int sndId, int rcvId, double rcvtime) {
    ...
    public Message copy(int rcvId, double rcvtime) {
        ...
        return new OrderingPMsg(v, n, m, i, sndId, rcvId, rcvtime);
    }
