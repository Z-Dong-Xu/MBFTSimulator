...
/**
 * @ClassName: MessageCMsg
 * @Description: 请求确认消息，类似Prepare消息
 * @Author: Dongxu Zhu
 **/
public class MessageCMsg extends Message{
    ...
    public MessageCMsg(int v, int n, Message m, int i, int sndId, int rcvId, double rcvtime) {
        super(sndId, rcvId, rcvtime);
        this.type = MessageC;
        this.len = MessageCMSGLEN;
        this.v = v;
        this.n = n;
        this.m = m;
        this.i = i;
    ...
    public Message copy(int rcvId, double rcvtime) {
        ...
        return new MessageCMsg(v, n, m, i, sndId, rcvId, rcvtime);
    }
