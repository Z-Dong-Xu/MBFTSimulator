...
/**
 * @ClassName: MessageDecisionMsg
 * @Description:
 * @Author: Dongxu Zhu
 **/
public class MessageDecisionMsg extends Message{
    public int v;
    ...
    public MessageDecisionMsg(int v, int n, Message m, int i, int sndId, int rcvId, double rcvtime) {
        super(sndId, rcvId, rcvtime);
        this.type = MessageDecision;
        this.len = MessageDecisionMSGLEN;
        this.v = v;
        this.n = n;
        this.m = m;
        this.i = i;
    ...
    public Message copy(int rcvId, double rcvtime) {
        ...
        return new MessageDecisionMsg(v, n, m, i, sndId, rcvId, rcvtime);
    }
