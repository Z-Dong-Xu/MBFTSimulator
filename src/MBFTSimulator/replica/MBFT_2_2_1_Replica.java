...
/**
 * @ClassName: MBFT_2_2_1_Replica
 * @Description:
 * @Author: Dongxu Zhu
 **/
public class MBFT_2_2_1_Replica extends Replica{
    ...
    public MBFT_2_2_1_Replica(int id, int[] netDlys, int[] netDlyToClis) {
        this.id = id;
