 ...
 * @Author: Dongxu Zhu
 **/
public class MBFT_1_2_2_Replica extends Replica{
    ...
    public MBFT_1_2_2_Replica(int id, int[] netDlys, int[] netDlyToClis) {
        this.id = id;
...
//			节点收到其他节点发来的提交消息时：
    ...
    public void receiveRequest(Message msg) {
        ...
        if(!hasRequset(n)){
            ...
            Message prePrepareMsg = new PrePrepareMsg(v, n, reqMsg, id, id, id, reqMsg.rcvtime);
            addMessageToCache(prePrepareMsg, n);
